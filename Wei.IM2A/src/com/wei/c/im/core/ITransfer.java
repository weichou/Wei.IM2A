...
public interface ITransfer extends IServer, Runnable {
	String CRLF = "\r\n";
	byte CR = '\r';
	byte LF = '\n';

	public static interface OnTransferListener {
		void onStartWork(ITransfer transfer);
		/**被服务端踢掉**/
		void onServerKicked(ITransfer transfer);
		void onError(ITransfer transfer, Exception e);
		void onStopWork(ITransfer transfer);
	}
}
